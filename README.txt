This project is about implementing the Person's Coorelation Feature-Selection method to select the best features from the data we have and then using those featuer to predict the class of other data labels related to that data.
